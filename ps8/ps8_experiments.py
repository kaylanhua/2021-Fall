import numpy as np
import random
from ps8_helpers import timeout, color, generate_line_of_ring_subgraphs, generate_random_linked_cluster, COLORS
from ps8 import Graph, exhaustive_search_coloring, bfs_2_coloring, iset_bfs_3_coloring, sat_3_coloring
random.seed(120)
...
def benchmark():
    ...
    subgraph_line_parameter_range = (1, 2, 1)
    cluster_graph_p_parameter_range = (0.2, 0.95, 0.15)
    cluster_graph_cluster_size_parameter_range = (800, 2000, 100)
